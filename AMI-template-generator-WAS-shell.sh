...
Security=$(echo $Secutiry | sed -e 's/None//g' -e 's/ //g')
...
echo -e '{
  ...
  "variables": {
    ...
    "ami_name": "AMI-EC2-WAS_{{isotime \"2006-01-02_1504\"}}"
  },
  "builders": [
    {
      "type": "amazon-ebs",
      ...
      "ssh_bastion_private_key_file": "~linux/terraform/rsa_key/awx_key.pem",
      "vpc_id": "'${VPC}'",
      "subnet_id": "'${Subnet}'",
